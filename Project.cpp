...
void display_all()
{
	...
	{
		cout << "\nRegistration No: of Student: " << st.srno;
		cout << "\nName of Student: " << st.name;
		cout << "\nProgramming Marks out of 100: " << st.p_marks;
		cout << "\nICT Marks out of 100: " << st.ict_marks;
		cout << "\nFuntional English Marks out of 100: " << st.e_marks;
		cout << "\nPre-Calculus Marks out of 100: " << st.pcal_marks;
		cout << "\nIslamic Studies and Pakistan Studies Marks out of 100: " << st.is_ps_marks;
